%X=
%filebuffer file to write openscad output to
%string bildprefix
%string bildpostfix
...
function X=createoutput(file, bildprefix, bildpostfix, bildint, digits, Alpha, R, vsteps, hsteps, tol)
currentimage=0;
